...
app.FlightListView = Backbone.View.extend({
  ...
  render: function() {
    ...
    this.$el.append("<ul class='flight-ul' id='flight-" + flight_id + "'><li class='displaylist'>" + origin + "</li><li class='displaylist'>" + destination + "</li><li class='displaylist'>" + date + "</li><li class='displaylist' id='seat-avail-" + flight_id + "'></li></ul>");
